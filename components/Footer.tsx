      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            aria-label="Instagram HMPS Informatika"
          >
            <svg
            ...
            <span className="text-sm">@hmpsinformatikaa</span>
          </a>
          ...
          <a
            ...
            aria-label="WhatsApp HMPS Informatika"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <span className="text-sm">085163741320</span>
          </a>
        </div>
